...
class FormatConverter:
    ...
    def _to_txt(self, content: str, title: str, output_file: Path, chapters: List[Dict] = None) -> str:
        """转换为TXT"""
...
""")
    ...
    def _to_markdown(
        self, content: str, title: str, output_file: Path, chapters: List[Dict] = None, metadata: Dict = None
    ) -> str:
        """转换为Markdown"""
        meta = metadata or {}
    ...
    def _to_epub(
        ...
        try:
            ...
            return self._to_html(content, title, output_file.with_suffix(".html"), chapters, metadata)
...
class ImageManager:
    ...
    def insert_image_marker(self, content: str, position: int, image_name: str, alt_text: str = "插图") -> str:
        """在内容中插入图片标记"""
