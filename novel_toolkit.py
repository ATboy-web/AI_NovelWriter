...
class WebSearchAdaptEngine:
    ...
    HOT_MEMES = {
        "热梗改编": [
            ...
            {"name":"口头支票套餐","desc":"画大饼，听着香实际是空气","adapt":"宗主在台上慷慨激昂：'只要打败魔族，每人奖励仙丹百颗、灵石万枚！'{name}热血沸腾地冲了上去。战后他去领赏，宗主拍拍他肩膀：'年轻人，修行之路不能太看重物质嘛。'——口头支票套餐，续费失败。"},
            {"name":"前排嗑瓜区","desc":"吃瓜群众，自带小马扎","adapt":"{name}发现了一个惊天秘密：宗门大师兄和魔教圣女在月下幽会。他没有声张，默默从储物袋里掏出小板凳和瓜子，坐在树上开始嗑。'嗯，这瓜真甜。'大师兄发现了他：'你在干什么？''前排嗑瓜，您继续。'"},
            {"name":"深度躺平模式","desc":"摆烂，啥也不想干","adapt":"系统问{name}：'你想成为什么样的强者？'{name}想了想：'我想成为那种不用修炼就能变强的强者。'系统沉默了：'...这不符合设定。''那就让我进入深度躺平模式吧。'{name}翻了个身继续睡。系统第一次遇到这种宿主。"},
            {"name":"带薪摸鱼KPI","desc":"工作没干完，摸鱼不能断","adapt":"{name}在宗门的KPI是每月完成100次任务。但他发现了一个bug：只要在任务大厅坐着，系统就会自动记录为'执行中'。于是他每天带着零食去任务大厅摸鱼，月底KPI居然满分。宗主表扬他：'效率最高的弟子！'{name}心虚地笑了笑。"},
            {"name":"卷王争霸赛","desc":"竞争激烈到极致","adapt":"宗门大比前夜，所有弟子都在疯狂修炼。{name}本想早点睡，结果发现隔壁的师弟已经修炼到第三层。他坐不住了，连夜突破到第四层。第二天早上，师弟笑着展示第五层的修为。{name}：'你是不是不用睡觉的？'"},
            {"name":"显眼包上线","desc":"出风头，走到哪都炸","adapt":"{name}天生就是个显眼包。别人低调修炼，他偏要在广场上练剑还自带BGM。别人安静吃饭，他偏要表演用筷子夹苍蝇。宗主忍无可忍：'你能不能低调点？''宗主，低调不符合我的人设。'{name}甩了甩头发。"},
            {"name":"情绪瞬间破防","desc":"崩溃，一点小事就炸","adapt":"{name}是宗门最强的弟子，元婴期大圆满，百战百胜。但今天他破防了——因为他的灵宠猫把他的丹药全吃了。'那可是我攒了三年的丹药啊！'{name}抱着空药瓶嚎啕大哭。旁边的师弟们面面相觑：'原来高手也会为猫崩溃...'"},
            {"name":"这波太顶了","desc":"非常棒，夸人不重样","adapt":"{name}在擂台上一招秒杀了对手。全场沉默了三秒，然后爆发出山呼海啸般的欢呼：'这波太顶了！''简直是天花板！''绝绝子！'{name}抱拳致意，心里却在想：'其实我只是手滑了...'"},
        ],
        "新闻改编": [
        ...
        "冷笑话素材": [
            ...
            {"name":"减肥的最高境界","adapt":"{name}宣布开始减肥，第一天：'今天只吃一碗饭。'第二天：'今天只吃半碗。'第三天：'今天不吃饭，只吃菜。'第四天：'菜也是食物啊！'{name}一边啃鸡腿一边感慨：减肥的最高境界就是——口头减肥。"},
            {"name":"社恐穿越","adapt":"社恐患者{name}穿越到了修仙世界，发现这里的人打招呼都是'道友请留步'然后开打。他每天最大的挑战不是修炼，而是如何避免跟人打招呼。'我可以闭关一百年吗？''可以，但你得先跟宗主报备。'——社恐的噩梦。"},
            {"name":"996修仙","adapt":"{name}穿越后发现修仙界也是996：早上9点开始修炼，晚上9点结束，一周6天。'这跟上班有什么区别？''区别是你修炼能长生。''那我宁愿不长生，让我睡个懒觉！'"},
            {"name":"AI算命","adapt":"{name}在集市上摆摊算命，用的不是八卦罗盘，而是一个AI算命系统。'施主，根据大数据分析，你近期有血光之灾。''怎么化解？''充值VIP会员，解锁化解方案。'——科技改变玄学。"},
            {"name":"修仙界的双十一","adapt":"每年双十一，修仙界各大宗门都会举办'法宝狂欢节'。{name}本来只想买一把飞剑，结果被'满1000灵石减200'的活动吸引，最后买了一堆用不上的法宝。'我是不是被套路了？''不，你这叫理性消费。'"},
            {"name":"社畜的觉醒","adapt":"{name}是标准的社畜，每天加班到深夜。直到有一天他发现自己觉醒了一个特殊能力：只要领导说'辛苦了'，他的修为就会提升一级。于是他开始疯狂加班——不是为了工资，是为了修炼。"},
            {"name":"相亲修罗场","adapt":"{name}被安排相亲，对方是一位元婴期女修。'你什么修为？''炼气三层。'女修皱了皱眉。'但我有房——灵脉上的洞府。'女修眼睛亮了。'还有车——飞行法器。'女修微笑。'还有存款——百万灵石。'女修：'什么时候结婚？'"},
        ],
    }
