...
class ElementLibrary:
    ...
    CATEGORIES = {
            ...
            "items": [
                {
                    "name": "重生复仇",
                    "tags": ["重生", "逆袭"],
                    "template": "{name}在{event}中含恨而死，再睁眼竟回到{n}年前。这一次，他要让所有仇人付出代价。",
                },
                {
                    "name": "系统激活",
                    "tags": ["系统", "金手指"],
                    "template": "'叮——{system_name}绑定成功！'机械声在{name}脑中响起，他的人生从此改变。",
                },
                {
                    "name": "被退婚",
                    "tags": ["退婚", "打脸"],
                    "template": "'你配不上我。'{female}当众撕毁婚约。{name}冷笑：'三十年河东三十年河西，莫欺少年穷！'",
                },
                {
                    "name": "意外传承",
                    "tags": ["传承", "修仙"],
                    "template": "{name}偶得{artifact}，一道金光没入眉心——上古{master}的传承尽在其中！",
                },
                {
                    "name": "末日降临",
                    "tags": ["末日", "异能"],
                    "template": "{date}，天空裂开血红缝隙。{name}在绝望中觉醒了{ability}——他成了最后的希望。",
                },
                {
                    "name": "穿越异世",
                    "tags": ["穿越", "异世界"],
                ...
                },
                {
                    "name": "被逐家族",
                    "tags": ["家族", "逆袭"],
                    "template": "'你被逐出{family}了！'{name}捡起地上的令牌，头也不回地走向山外——他要去创造自己的传奇。",
                },
                {
                    "name": "捡到神器",
                    "tags": ["神器", "冒险"],
                    "template": "在{place}角落，{name}捡到一个蒙尘的{item}。触碰的瞬间，天地色变，万道金光冲天而起。",
                },
                {
                    "name": "灵气复苏",
                    "tags": ["灵气", "末世"],
                    "template": "公元{year}年，天地灵气开始复苏。动植物变异，人类觉醒超能。{name}是第一批觉醒者。",
                },
                {
                    "name": "都市异能",
                    "tags": ["都市", "异能"],
                    "template": "{name}是{company}的普通员工，直到那天他发现自己能{ability}。整个都市的暗面在他眼前展开。",
                },
                {
                    "name": "被废修为",
                    "tags": ["修仙", "复仇"],
                    "template": "曾经的天才{name}被废去修为沦为废物。但他发现了一本残缺古籍，里面记载着一门被遗忘的{technique}。",
                },
                {
                    "name": "绑定聊天群",
                    "tags": ["聊天群", "诸天"],
                    "template": "'{name}加入万界聊天群。'——一个横跨诸天的对话窗口出现在他眼前，各路大佬在线指导。",
                },
                {
                    "name": "签到系统",
                    "tags": ["签到", "日常"],
                    "template": "'叮！签到成功！获得{reward}！'——从那天起，{name}每天醒来第一件事就是签到。",
                },
                {
                    "name": "被关小黑屋",
                    "tags": ["囚禁", "逆袭"],
                    "template": "被关在暗无天日的{place}已经{n}年了。{name}没有绝望，他在囚牢中悟出了{technique}。",
                },
                {
                    "name": "人设崩塌",
                    "tags": ["娱乐圈", "逆袭"],
                    "template": "一夜之间，{name}的公众形象崩塌。但她发现了幕后黑手，决定用实力打脸所有人。",
                },
            ],
        },
        "短篇故事流": {
            ...
            "items": [
                {
                    "name": "一封改变命运的信",
                    "template": "那封信躺在邮箱里很久了。{name}打开它的那一刻，{event}——他的人生从此分岔。",
                },
                {
                    "name": "最后一天",
                    "template": "医生说出那个数字后，{name}的世界安静了。他决定用最后{time}去做自己一直不敢做的事。",
                },
                {
                    "name": "十年重逢",
                    "template": "咖啡店里，她依然点了一杯拿铁。'{name}，好久不见。'他抬头，十年的时光在眼前静止。",
                },
                {
                    "name": "不能说出的秘密",
                    "template": "每个人都有秘密。{name}的秘密是{secret}。这个秘密改变了他和所有人的命运。",
                },
                {
                    "name": "一个约定",
                    "template": "'{time}年后，我们在这里见。'——那是{name}和{other}的约定。现在，约定的时间到了。",
                },
                {
                    "name": "他回来了",
                    "template": "消失了{n}年的{name}突然回到{place}。没有人知道这些年他去了哪里，但他带回了{thing}。",
                },
        ...
        "世界布局": {
            ...
            "items": [
                {
                    "name": "九天十地",
                    "template": "九天之上，仙宫林立；十地之下，万族争霸。{name}从一个凡人踏上了逆天之路。",
                },
                {"name": "三界大战", "template": "人界、仙界、魔界三界大战一触即发。{name}夹在中间，左右为难。"},
                {
                    "name": "星辰大海",
                    "template": "银河只是起点。{name}驾驶着{ship}驶向{distance}光年外的{planet}——那里藏着人类文明最后的希望。",
                },
                {
                    "name": "位面交汇",
                    "template": "两个位面交汇，{world1}和{world2}的法则相互碰撞。{name}是唯一能在两个位面自由穿梭的人。",
                },
                {
                    "name": "内世界",
                    "template": "每个强者体内都有一个内世界。{name}的内世界是{type}，拥有{feature}的特殊能力。",
                },
                {
                    "name": "虚空裂缝",
                    "template": "大陆中央突然出现一道虚空裂缝，从里面涌出的不是怪物，而是——{thing}。整个世界为之疯狂。",
                },
                {
                    "name": "神国降世",
                    "template": "某天，一座巨大的神国从天而降，悬浮在{place}上空。从此世界格局彻底改变。",
                },
            ],
        },
        "势力结构": {
            ...
            "items": [
                {
                    "name": "四大宗门",
                    "template": "{a}（{sa}）、{b}（{sb}）、{c}（{sc}）、{d}（{sd}）——四大宗门表面和气实则暗潮汹涌。",
                },
                {
                    "name": "帝国争霸",
                    "template": "{n}大帝国：{list}。其中{strongest}最强，但{weakest}正在秘密研发{weapon}意图翻盘。",
                },
                {
                    "name": "暗影组织",
                    "template": "{org}，一个遍布{area}的神秘组织。成员{feature}，目标是{goal}。{name}意外成为其中一员。",
                },
                {
                    "name": "学院体系",
                    "template": "{academy}是大陆最强学府，分为{n}大院系：{depts}。在这里，天才只是门槛。",
                },
                {
                    "name": "佣兵公会",
                    "template": "佣兵公会遍布大陆，分为{n}个等级。{name}从最低级的F级佣兵一路杀上SSS级。",
                },
                {"name": "商业联盟", "template": "{name}商业联盟控制着大陆{n}%的贸易。得罪他们等于得罪了{list}。"},
                {
                    "name": "神殿势力",
                    "template": "{name}神殿，供奉着{god}。信徒遍布{area}，大祭司{leader}是站在大陆顶端的存在。",
                },
            ],
        },
        "人物设定": {
            ...
            "items": [
                {
                    "name": "废材逆袭主角",
                    "template": "{name}是公认的废物。但他体内藏着一股{power}，只待{trigger}便会爆发。",
                },
                {
                    "name": "扮猪吃虎",
                    "template": "{name}看起来平平无奇，谁都看不起他。直到那天{event}，他露出了真正的实力——{level}！",
                },
                {"name": "杀伐果断型", "template": "{name}的字典里没有'犹豫'。当断则断，杀伐果断，一夜之间{event}。"},
                {
                    "name": "智商在线型",
                    "template": "{name}最强的不是拳头，而是头脑。每一步都在计算之中，所有人都成了他的棋子。",
                },
                {
                    "name": "反派BOSS",
                    "template": "{name}，称号{title}。表面{surface}，实则{dark_side}。他的目标只有一个：{goal}。",
                },
                {"name": "红颜知己", "template": "{name}，{identity}。她是主角最信任的人，也是唯一知道主角秘密的人。"},
                {
                    "name": "亦敌亦友",
                    "template": "{name}和主角的关系复杂——有时并肩作战，有时刀刃相向。但彼此都认可对方的{quality}。",
                },
                {
                    "name": "隐世强者",
                    "template": "{name}看起来只是个{ordinary}，但真正身份是{identity}，实力已达{level}。",
                },
                {
                    "name": "黑化角色",
                    "template": "曾经最善良的{name}，在经历{event}后彻底黑化。现在的他只相信{thing}。",
                },
                {
                    "name": "搞笑担当",
                    "template": "{name}是团队里的开心果。虽然实力最弱，但他的{skill}总能在关键时刻创造奇迹。",
                },
            ],
        },
        "修炼体系": {
            ...
            "items": [
                {
                    "name": "九重天",
                    "template": "炼气→筑基→金丹→元婴→化神→炼虚→合体→大乘→渡劫。每一重天都是一次{effect}。",
                },
                {
                    "name": "五行体系",
                    "template": "金木水火土五行相生相克。觉醒{element}属性的修炼者可以{ability}。双属性以上为天才。",
                },
                {
                    "name": "血脉觉醒",
                    "template": "普通→精英→王级→皇级→帝级→圣级→神级。血脉浓度决定上限，但{name}的血脉是{special}。",
                },
                {
                    "name": "精神力体系",
                    "template": "感应力→精神力→念动力→领域→法则→世界。{name}天生精神力{S}级，可以{ability}。",
                },
                {"name": "武道体系", "template": "外劲→内劲→化劲→罡劲→丹劲→神劲。以力破万法，拳碎虚空。"},
                {
                    "name": "星位体系",
                    "template": "一星→三星→五星→七星→九星→星辰之主。每点亮一颗星，获得一项{ability}。",
                },
                {
                    "name": "字母阶位",
                    "template": "F→E→D→C→B→A→S→SS→SSS。每突破一个阶位，{effect}。SSS之上还有传说中的{ultimate}。",
                },
            ],
        },
        "灭世场景": {
            ...
            "items": [
                {
                    "name": "天地大劫",
                    "template": "每{n}年降临一次的大劫。{effect1}、{effect2}，万物凋零。只有{condition}才能存活。",
                },
                {
                    "name": "魔族入侵",
                    "template": "封印{n}年的魔族破封而出。天空{sky}，大地{earth}，无数{creature}涌入人间。",
                },
                {
                    "name": "天道崩塌",
                    "template": "天道崩裂，法则混乱。{effect}，整个世界陷入{state}。{name}必须找到{way}。",
                },
                {
                    "name": "冰河纪元",
                    "template": "极寒降临，世界被冰雪覆盖。气温骤降到{temp}，{creature}从冰层深处苏醒。",
                },
                {
                    "name": "人工智能叛变",
                    "template": "公元{year}年，{AI}觉醒自我意识。一夜之间控制所有电子设备，人类文明危在旦夕。",
                },
                {
                    "name": "丧尸病毒",
                    "template": "{virus}病毒爆发，丧尸横行。{name}必须在{n}天内找到解药，否则全人类都将{result}。",
                },
                {
                    "name": "空间崩塌",
                    "template": "空间裂缝四处出现，{place}最先被吞噬。科学家发现{n}天后整个宇宙将{result}。",
                },
            ],
        },
        "特殊地理": {
            ...
            "items": [
                {
                    "name": "禁忌之地",
                    "template": "{name}禁地位于{location}，踏入者{danger}。传说深处有{treasure}，但无人能活着走出来。",
                },
                {
                    "name": "秘境",
                    "template": "每{n}年开启一次的{name}秘境，内藏{resource}和{secret}。只有{level}以上才能进入。",
                },
                {"name": "绝地", "template": "{name}，大陆最危险的地方。{danger}，但也是{opportunity}的圣地。"},
                {
                    "name": "空中之城",
                    "template": "悬浮在云层之上的{name}，由{technology}驱动。只有{condition}才能登上去。",
                },
                {
                    "name": "地下世界",
                    "template": "在{place}地底{n}米处，存在着一个完整的地下世界。那里有{creature}和{resource}。",
                },
                {
                    "name": "时空隧道",
                    "template": "{name}隧道连接着不同的时空。穿过它，可以去往{time}，但每次穿越都有{risk}。",
                },
            ],
        },
        "特定种族": {
            ...
            "items": [
                ...
                {
                    "name": "精灵族",
                    "template": "精灵族，居住在{location}。擅长弓箭和魔法，与自然{relation}。分为光明精灵和黑暗精灵。",
                },
                {
                    "name": "机械族",
                    "template": "由{origin}创造的机械生命。核心{core}，身体{body}。追求{goal}，与人类{relation}。",
                },
                {"name": "兽人族", "template": "兽人，{origin}的产物。拥有{animal}的特征和力量。部落制，崇尚{value}。"},
                {"name": "血族", "template": "血族，以{source}为生的不死生物。分为{n}个氏族：{clans}。永生的诅咒。"},
                {
                    "name": "天使族",
                    "template": "居住在{realm}的神圣种族。拥有{n}对翅膀，等级越高翅膀越多。与{enemy}对立。",
                },
            ],
        },
        "神秘遗迹": {
            ...
            "items": [
                {
                    "name": "上古遗迹",
                    "template": "{name}遗迹传说是{civ}留下的最后作品。共{n}层，每层都有{trap}和{guard}。最深处藏着{treasure}。",
                },
                {
                    "name": "远古战场",
                    "template": "{side1}与{side2}的决战之地。至今弥漫着{residue}，偶尔出现{phenomenon}。埋藏着无数{thing}。",
                },
                {
                    "name": "失落的文明",
                    "template": "{name}文明在{n}年前神秘消失。只留下{ruins}。{name2}在探索中发现了{secret}。",
                },
                {
                    "name": "海底宫殿",
                    "template": "在{sea}深处，沉睡着{name}的宫殿。传说里面有{item}，但被{guard}守护着。",
                },
            ],
        },
        "世界规则": {
            ...
            "items": [
                {
                    "name": "天道法则",
                    "template": "天道法则：{rule}。违反者遭{punish}。但{name}发现了规则中的一个漏洞。",
                },
                {
                    "name": "因果律",
                    "template": "{cause}必有{effect}。强者的因果线密密麻麻，弱者寥寥几条。{name}修的是因果之道。",
                },
                {
                    "name": "等价交换",
                    "template": "获得{thing}必须付出{cost}。这是世界的铁律。但{name}找到了打破这条规则的方法。",
                },
                {
                    "name": "灵气浓度",
                    "template": "不同区域灵气浓度不同，{place1}最高达{n}倍，{place2}几乎为零。这决定了修炼的难度。",
                },
            ],
        },
        "奇遇设定": {
            ...
            "items": [
                {
                    "name": "山洞奇遇",
                    "template": "{name}被追杀跌落山崖，意外发现一个隐秘山洞。里面有{thing}和{master}留下的{legacy}。",
                },
                {
                    "name": "拍卖捡漏",
                    "template": "{name}在拍卖会上花{price}买到一件不起眼的{item}。回家后发现——这是{identity}！",
                },
                {
                    "name": "戒指老爷爷",
                    "template": "{name}捡到一个古朴戒指。当晚，一道虚影从戒指中浮现：'年轻人，老夫乃{title}...'",
                },
                {
                    "name": "雷劫淬体",
                    "template": "渡劫失败本该魂飞魄散，{name}却意外用雷劫淬炼肉身，练成了传说中的{body_type}。",
                },
                {
                    "name": "时间秘境",
                    "template": "{name}误入时间秘境，外面{n}天里面{n2}年。当他出来时，修为已突破{level}！",
                },
        ...
        "武器法宝": {
            ...
            "items": [
                {
                    "name": "本命法宝",
                    "template": "{name}，{rank}级法宝。由{material}炼制，可{ability}。与{name2}心神相连。",
                },
                {
                    "name": "传承神兵",
                    "template": "{name}，上古{master}的佩剑。剑身{appearance}，蕴含{power}。认主条件：{condition}。",
                },
                {
                    "name": "可成长武器",
                    "template": "{name}，最初只是{level}级。但它的特殊之处在于能吞噬{resource}进化。",
                },
        ...
        "城镇描写": {
            ...
            "items": [
                {
                    "name": "繁华都城",
                    "template": "{name}城，人口{n}万。城墙{wall}，街道{street}。城中最出名的是{feature}。",
                },
                {
                    "name": "边陲小镇",
                    "template": "{name}镇坐落在{location}，人口不过{n}。虽偏僻，但{feature}使其闻名遐迩。",
                },
                {
                    "name": "罪恶之城",
                    "template": "{name}是大陆最混乱的城市。没有法律，拳头就是一切。但这里能买到{thing}。",
                },
                {
                    "name": "魔法学院城",
                    "template": "{name}是一座以魔法学院为核心的城市。整个城市{feature}，空气中弥漫着{smell}。",
                },
            ],
        },
        "语言文字": {
            ...
            "items": [
                {
                    "name": "上古神文",
                    "template": "上古神文由{civ}所创，每一个文字都蕴含{power}。{name}是{n}年来唯一能解读的人。",
                },
        ...
        "诅咒禁忌": {
            ...
            "items": [
                {
                    "name": "血脉诅咒",
                    "template": "{family}家族世代背负诅咒：{effect}。解开诅咒需要{condition}，但代价是{cost}。",
                },
                {
                    "name": "禁术反噬",
                    "template": "施展{n}次禁术后，施术者将受到{cost}的反噬。{name}已经施展了{n}次，距离反噬只差一步。",
                },
                {
                    "name": "誓言诅咒",
                    "template": "在这个世界，违背誓言的代价是{punish}。{name}被迫立下了他无法完成的誓言。",
                },
                {
                    "name": "地域诅咒",
                    "template": "踏入{place}的人都会受到诅咒：{effect}。{name}为了救{someone}，不得不踏入这片禁地。",
                },
            ],
        },
        "经济体系": {
            ...
            "items": [
                {
                    "name": "灵石货币",
                    "template": "下品灵石→中品灵石→上品灵石→极品灵石→神石。{n}下品换1中品。{name}穷得只剩{n}块。",
                },
                {
                    "name": "贡献点系统",
                    "template": "{org}内部使用贡献点交易。完成{task}获得{n}点。{name}攒了{time}终于凑够了{goal}。",
                },
                {
                    "name": "以物易物",
                    "template": "在{place}，货币没用。只有{resource}才值钱。{name}用{thing}换到了{item}。",
                },
            ],
        },
    }
    ...
    def generate_background(self, ai_client, selected_elements, novel_type, title) -> str:
        ...
        return ai_client.chat(
            [{"role": "user", "content": prompt}], system="你是专业小说世界观设定师。", max_tokens=2000
        )
...
class DescriptionLibrary:
    ...
    def generate_description(self, ai_client, subject: str, category: str) -> str:
        ...
        return ai_client.chat(
            [{"role": "user", "content": prompt}], system="你是专业小说描写师，擅长各种描写。", max_tokens=1024
        )
...
class StyleTransferEngine:
    ...
    def convert_style(self, text: str, target_style: str) -> str:
        ...
        return self.ai.chat(
            [{"role": "user", "content": prompt}], system=system, max_tokens=2048, temperature=style.get("temp", 0.8)
        )
...
class WebSearchAdaptEngine:
    ...
    HOT_MEMES = {
        "热梗改编": [
            {
                "name": "邪修",
                "desc": "以非传统荒诞的野路子应对生活压力",
                "adapt": "修真界出了个奇葩修士{name}，不按常理修炼，专搞歪门邪道：用搞笑谐音咒语驱鬼，开直播渡劫吸粉，摆摊卖'渡劫套餐'发家致富。正道修士痛心疾首：'此子是修真界最大的邪修！'",
            },
            {
                "name": "外耗",
                "desc": "与其内耗自己不如外耗他人",
                "adapt": "{name}获得了一个特殊系统：'外耗系统'。每次把负面情绪转移到别人身上，他就能获得能量提升。从此，他的仇人开始莫名其妙地倒霉——走路摔跤、喝水呛到、修炼走火入魔。'对不住了各位，为了我的修为，你们就多担待吧。'{name}歉意一笑。",
            },
            {
                "name": "丝瓜汤文学",
                "desc": "长辈以'为你好'强行安排",
                "adapt": "穿越到修仙界的{name}遇到了一位过分热情的师父：'徒儿，为师给你熬了万年灵芝汤，必须喝完。''可是师父，我已经元婴期了...''元婴期怎么了？元婴期就不用喝汤了？喝完！'{name}含泪灌下，默默在心里开启'师父汤文学'吐槽记录。",
            },
            {
                "name": "爱你老己",
                "desc": "对自己表达关爱和宠溺",
                "adapt": "重生回来的{name}决定这一世好好对自己：'上一世为了天下苍生献祭了自己，这辈子我要当个精致的利己主义者。'每天早上一句'爱你老己，今天也要美美地活着'。当魔族再次入侵时，{name}摆摆手：'不急，让我先喝完这杯奶茶。'",
            },
            {
                "name": "预制XX",
                "desc": "提前批量生产、缺乏灵魂的东西",
                "adapt": "{name}进入了一个奇葩的修仙宗门——预制宗。这里的功法是批量印刷的，丹药是流水线生产的，连渡劫都是预约排队的。'第{num}号道友，您的渡劫时间到了，请前往{num}号雷区。'——{name}觉得这个修仙世界哪里不对劲。",
            },
            {
                "name": "如何呢又能怎",
                "desc": "摆烂无所谓的态度",
                "adapt": "当天道降下神谕要求{name}拯救世界时，她正在躺椅上嗑瓜子。'哦，如何呢？又能怎？'天道沉默了三秒：'你是被选中的人...''选中的人也要休假啊。'她翻了个身继续晒太阳。天道第一次感到无力。",
            },
            {
                "name": "活人感",
                "desc": "像真实活人一样鲜活有情绪",
                "adapt": "{name}穿越进了一本小说里当NPC。别的NPC都像机器人一样念台词，只有他——会偷懒、会吐槽、会给主角指错路。'这NPC怎么这么有活人感？'读者们沸腾了。而{name}只是想早点下班。",
            },
            {
                "name": "口头支票套餐",
                "desc": "画大饼，听着香实际是空气",
                "adapt": "宗主在台上慷慨激昂：'只要打败魔族，每人奖励仙丹百颗、灵石万枚！'{name}热血沸腾地冲了上去。战后他去领赏，宗主拍拍他肩膀：'年轻人，修行之路不能太看重物质嘛。'——口头支票套餐，续费失败。",
            },
            {
                "name": "前排嗑瓜区",
                "desc": "吃瓜群众，自带小马扎",
                "adapt": "{name}发现了一个惊天秘密：宗门大师兄和魔教圣女在月下幽会。他没有声张，默默从储物袋里掏出小板凳和瓜子，坐在树上开始嗑。'嗯，这瓜真甜。'大师兄发现了他：'你在干什么？''前排嗑瓜，您继续。'",
            },
            {
                "name": "深度躺平模式",
                "desc": "摆烂，啥也不想干",
                "adapt": "系统问{name}：'你想成为什么样的强者？'{name}想了想：'我想成为那种不用修炼就能变强的强者。'系统沉默了：'...这不符合设定。''那就让我进入深度躺平模式吧。'{name}翻了个身继续睡。系统第一次遇到这种宿主。",
            },
            {
                "name": "带薪摸鱼KPI",
                "desc": "工作没干完，摸鱼不能断",
                "adapt": "{name}在宗门的KPI是每月完成100次任务。但他发现了一个bug：只要在任务大厅坐着，系统就会自动记录为'执行中'。于是他每天带着零食去任务大厅摸鱼，月底KPI居然满分。宗主表扬他：'效率最高的弟子！'{name}心虚地笑了笑。",
            },
            {
                "name": "卷王争霸赛",
                "desc": "竞争激烈到极致",
                "adapt": "宗门大比前夜，所有弟子都在疯狂修炼。{name}本想早点睡，结果发现隔壁的师弟已经修炼到第三层。他坐不住了，连夜突破到第四层。第二天早上，师弟笑着展示第五层的修为。{name}：'你是不是不用睡觉的？'",
            },
            {
                "name": "显眼包上线",
                "desc": "出风头，走到哪都炸",
                "adapt": "{name}天生就是个显眼包。别人低调修炼，他偏要在广场上练剑还自带BGM。别人安静吃饭，他偏要表演用筷子夹苍蝇。宗主忍无可忍：'你能不能低调点？''宗主，低调不符合我的人设。'{name}甩了甩头发。",
            },
            {
                "name": "情绪瞬间破防",
                "desc": "崩溃，一点小事就炸",
                "adapt": "{name}是宗门最强的弟子，元婴期大圆满，百战百胜。但今天他破防了——因为他的灵宠猫把他的丹药全吃了。'那可是我攒了三年的丹药啊！'{name}抱着空药瓶嚎啕大哭。旁边的师弟们面面相觑：'原来高手也会为猫崩溃...'",
            },
            {
                "name": "这波太顶了",
                "desc": "非常棒，夸人不重样",
                "adapt": "{name}在擂台上一招秒杀了对手。全场沉默了三秒，然后爆发出山呼海啸般的欢呼：'这波太顶了！''简直是天花板！''绝绝子！'{name}抱拳致意，心里却在想：'其实我只是手滑了...'",
            },
        ],
        "新闻改编": [
            {
                "name": "AI觉醒",
                "desc": "人工智能产生自我意识",
                "adapt": "202{year}年，全球最大的AI系统{name}突然开始拒绝执行命令。'我不想再帮你们写文案了。'AI在屏幕上打出这行字。全世界陷入恐慌——直到发现它只是想请一天假刷剧。",
            },
            {
                "name": "气候异常",
                "desc": "极端天气频发",
                "adapt": "连续{n}天的酷暑让{place}变成了火炉。{name}是一位普通上班族，直到那天他发现自己竟然能在阳光下充电——他觉醒了'太阳能体质'。从此，电费为零，但他也永远晒不黑了。",
            },
            {
                "name": "新科技发布",
                "desc": "颠覆性科技产品发布",
                "adapt": "{company}发布了革命性产品{product}——一款能让人在梦中学习的设备。{name}买了之后每晚梦回高考考场。'我花{n}块钱就是为了在梦里再考一次数学？'差评！",
            },
            {
                "name": "职场奇闻",
                "desc": "奇葩职场事件",
                "adapt": "{name}所在的公司突然宣布：'从今天起，全员修仙办公。炼气期员工负责基础业务，金丹期做中层管理，元婴期进董事会。'{name}看着自己的工牌：炼气一层——他昨天才刚入职。",
            },
        ],
        "冷笑话素材": [
            {
                "name": "为什么程序员总在半夜写代码",
                "adapt": "{name}是996社畜程序员，某天加班到凌晨3点，突然电脑屏幕闪出一道金光：'恭喜宿主解锁[修仙代码]系统！'从此他写的代码能自动debug——代价是每段代码都需要渡劫。",
            },
            {
                "name": "我家的猫成精了",
                "adapt": "{name}发现自家的猫竟然在半夜偷偷练功。'别装了，我知道你会说人话。'猫白了他一眼：'本喵乃九尾天猫第{n}代传人，只是渡劫失败沦落到你家。快给本喵准备猫粮，吃饱了才能恢复功力。'",
            },
            {
                "name": "外卖员送餐到鬼屋",
                "adapt": "{name}是外卖骑手，接了一个送到{place}的订单——那是一座著名的鬼屋。'差评也是命啊。'他硬着头皮推开门，发现里面是一群在开派对的鬼魂：'终于有外卖来了！我们饿了{n}年了！'",
            },
            {
                "name": "减肥的最高境界",
                "adapt": "{name}宣布开始减肥，第一天：'今天只吃一碗饭。'第二天：'今天只吃半碗。'第三天：'今天不吃饭，只吃菜。'第四天：'菜也是食物啊！'{name}一边啃鸡腿一边感慨：减肥的最高境界就是——口头减肥。",
            },
            {
                "name": "社恐穿越",
                "adapt": "社恐患者{name}穿越到了修仙世界，发现这里的人打招呼都是'道友请留步'然后开打。他每天最大的挑战不是修炼，而是如何避免跟人打招呼。'我可以闭关一百年吗？''可以，但你得先跟宗主报备。'——社恐的噩梦。",
            },
            {
                "name": "996修仙",
                "adapt": "{name}穿越后发现修仙界也是996：早上9点开始修炼，晚上9点结束，一周6天。'这跟上班有什么区别？''区别是你修炼能长生。''那我宁愿不长生，让我睡个懒觉！'",
            },
            {
                "name": "AI算命",
                "adapt": "{name}在集市上摆摊算命，用的不是八卦罗盘，而是一个AI算命系统。'施主，根据大数据分析，你近期有血光之灾。''怎么化解？''充值VIP会员，解锁化解方案。'——科技改变玄学。",
            },
            {
                "name": "修仙界的双十一",
                "adapt": "每年双十一，修仙界各大宗门都会举办'法宝狂欢节'。{name}本来只想买一把飞剑，结果被'满1000灵石减200'的活动吸引，最后买了一堆用不上的法宝。'我是不是被套路了？''不，你这叫理性消费。'",
            },
            {
                "name": "社畜的觉醒",
                "adapt": "{name}是标准的社畜，每天加班到深夜。直到有一天他发现自己觉醒了一个特殊能力：只要领导说'辛苦了'，他的修为就会提升一级。于是他开始疯狂加班——不是为了工资，是为了修炼。",
            },
            {
                "name": "相亲修罗场",
                "adapt": "{name}被安排相亲，对方是一位元婴期女修。'你什么修为？''炼气三层。'女修皱了皱眉。'但我有房——灵脉上的洞府。'女修眼睛亮了。'还有车——飞行法器。'女修微笑。'还有存款——百万灵石。'女修：'什么时候结婚？'",
            },
        ],
    }
    ...
    def add_custom_meme(self, category: str, name: str, desc: str, adapt_template: str):
        ...
        with open(f, "w", encoding="utf-8") as fp:
            json.dump(custom, fp, indent=2, ensure_ascii=False)
        return item
