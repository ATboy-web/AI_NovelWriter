...
class ShellMixin:
    ...
    def _create_widgets(self):
        ...
        for text, cmd in [
            ...
            ("打开", self._open_novel),
            ("导出", self._export_txt),
            ("格式转换", self._show_format_converter),
            ("插入图片", self._insert_image),
            ("云端同步", self._cloud_sync),
        ...
        outline_type_combo = ttk.Combobox(
            outline_header,
            textvariable=self.outline_type_var,
        ...
        tk.Button(
            ...
            relief=tk.FLAT,
            padx=4,
            command=self._add_outline_item,
        ).pack(side=tk.LEFT, padx=1)
        tk.Button(
            outline_btn_frame,
            text="编辑",
            ...
            relief=tk.FLAT,
            padx=4,
            command=self._edit_outline_item,
        ).pack(side=tk.LEFT, padx=1)
        tk.Button(
            outline_btn_frame,
            text="删除",
            ...
            relief=tk.FLAT,
            padx=4,
            command=self._delete_outline_item,
        ...
        tk.Button(
            ...
            relief=tk.FLAT,
            padx=6,
            command=self._create_character_dialog,
        ).pack(side=tk.LEFT, padx=1)
        tk.Button(
            char_btn_frame,
            text="AI生成",
            ...
            relief=tk.FLAT,
            padx=6,
            command=self._ai_create_character,
        ).pack(side=tk.LEFT, padx=1)
        tk.Button(
            char_btn_frame,
            text="传记",
            ...
            relief=tk.FLAT,
            padx=6,
            command=self._gen_char_biography,
        ).pack(side=tk.LEFT, padx=1)
        ...
        tk.Button(
            ...
            relief=tk.FLAT,
            padx=6,
            command=self._show_char_detail,
        ).pack(side=tk.LEFT, padx=1)
        ...
        self.char_select_combo = ttk.Combobox(
            char_select_frame, textvariable=self.char_select_var, state="readonly", width=16
        )
        ...
        tk.Button(
            ...
            relief=tk.FLAT,
            padx=10,
            command=self._send_sticky_to_project,
