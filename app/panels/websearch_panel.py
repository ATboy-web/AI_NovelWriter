...
class WebSearchPanelMixin:
    ...
    def _build_websearch_tool(self):
        ...
        tk.Button(
            ...
            relief=tk.FLAT,
            padx=10,
            command=self._ws_generate_from_list,
        ).pack(pady=5)
        ...
        tk.Button(
            ...
            relief=tk.FLAT,
            padx=10,
            command=self._ws_delete_custom,
        ).pack(side=tk.LEFT, padx=5)

        # 结果展示
        self.ws_result = tk.Text(
            f,
            height=12,
            wrap=tk.WORD,
            font=("微软雅黑", 10),
        ...
        tk.Button(
            ...
            relief=tk.FLAT,
            padx=10,
            command=lambda: self._insert_to_chapter(self.ws_result),
        ).pack(pady=5)
